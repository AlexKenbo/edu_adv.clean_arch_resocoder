...
import 'package:clean_arch_resocoder/core/error/failures.dart';
import 'package:clean_arch_resocoder/core/network/network_info.dart';
import 'package:clean_arch_resocoder/features/number_trivia/data/datasources/number_trivia_local_data_source.dart';
import 'package:clean_arch_resocoder/features/number_trivia/data/datasources/number_trivia_remote_data_source.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline( () {
      ...
      test(
        'should return cache the data locally when the call to remote data source is successful',
        () async {
          //arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any)).thenAnswer((_) async => tNumberTriviaModel);
          //act
